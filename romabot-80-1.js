        ...
        try {
            ...
            try {
                ...
                if (_isCreatorQuestion(rawText)) {
                    ...
                    const _waitMs = 4000 + Math.floor(Math.random() * 3001) // 4000–7000ms
                ...
                // ══ TYPEWRITER: 7 kata per 0.01 detik (10ms) ══
                const _header = `RomaAi✨\n━━━━━━━━━━━━━━━\n`
                const _words = reply.split(' ')
                const _chunk = 7
                const _delay = 10  // 0.01 detik = 10ms
                ...
                if (_sentKey && _words.length > _chunk) {
                    for (let i = _chunk; i < _words.length; i += _chunk) {
                        ...
                        try {
                            await sock.sendMessage(from, { text: _txt, edit: _sentKey })
                        } catch(e) { break }
                    }
                }
